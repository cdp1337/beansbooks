...
class Beans_Customer_Payment_Create extends Beans_Customer_Payment {
	...
	protected function _execute()
	{
		...
		$create_transaction_data->type = isset($this->_data->type) ? $this->_data->type : NULL;
		$create_transaction_data->reference = isset($this->_data->reference) ? $this->_data->reference : NULL;
